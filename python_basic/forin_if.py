...
exe = [f for f in file_name if 'exe' in f]
print(exe)
...
len10 = [f for f in file_name if len(f) >= 10]
print(len10)


#(14) 다음 리스트에서 소문자만 가지는 새로운 리스트를 만드시오.
str_list = ["A", "B", "c", "D", "E", "F", "g", "h", "I", "J", "k"]
lowerli = [s for s in str_list if s >= 'a']
print(lowerli)